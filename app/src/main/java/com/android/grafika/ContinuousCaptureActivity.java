...
public class ContinuousCaptureActivity extends Activity
  ...
  public void surfaceCreated(SurfaceHolder holder) {
    ...
    try {
      mCircEncoder =
          new CircularEncoder(VIDEO_WIDTH, VIDEO_HEIGHT, 6000000, mCameraPreviewThousandFps / 1000,
              7, mHandler);
    } catch (IOException ioe) {
      throw new RuntimeException(ioe);
    }
  ...
  private static class MainHandler extends Handler implements CircularEncoder.Callback {
    ...
    @Override public void bufferStatus(long totalTimeMsec) {
      sendMessage(
          obtainMessage(MSG_BUFFER_STATUS, (int) (totalTimeMsec >> 32), (int) totalTimeMsec));
    }
