...
public class Sprite2d {
  ...
  public void draw(FlatShadedProgram program, float[] projectionMatrix) {
    ...
    program.draw(mScratchMatrix, mColor, mDrawable.getVertexArray(), 0, mDrawable.getVertexCount(),
        mDrawable.getCoordsPerVertex(), mDrawable.getVertexStride());
  }
  ...
  public void draw(Texture2dProgram program, float[] projectionMatrix) {
    ...
    program.draw(mScratchMatrix, mDrawable.getVertexArray(), 0, mDrawable.getVertexCount(),
        mDrawable.getCoordsPerVertex(), mDrawable.getVertexStride(), GlUtil.IDENTITY_MATRIX,
