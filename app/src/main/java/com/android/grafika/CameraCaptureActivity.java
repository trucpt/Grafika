...
public class CameraCaptureActivity extends Activity
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayAdapter<CharSequence> adapter =
        ArrayAdapter.createFromResource(this, R.array.cameraFilterNames,
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
  ...
  public void updateFilter() {
    ...
    switch (mNewFilter) {
      ...
      case CameraCaptureActivity.FILTER_BLUR:
        ...
        final float TEMP = 16f;
        kernel = new float[] {
            1f / TEMP, 2f / TEMP, 1f / TEMP,
            2f / TEMP, 4f / TEMP, 2f / TEMP,
            1f / TEMP, 2f / TEMP, 1f / TEMP
        };
        break;
  ...
  @Override public void onSurfaceCreated(GL10 unused, EGLConfig config) {
    ...
    mCameraHandler.sendMessage(
        mCameraHandler.obtainMessage(CameraCaptureActivity.CameraHandler.MSG_SET_SURFACE_TEXTURE,
            mSurfaceTexture));
  }
      ...
      switch (mRecordingStatus) {
        case RECORDING_OFF:
          ...
          mVideoEncoder.startRecording(
              new TextureMovieEncoder.EncoderConfig(mOutputFile, 640, 480, 1000000,
