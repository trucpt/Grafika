 ...
 */
public class ScheduledSwapActivity extends Activity
    implements OnItemSelectedListener, SurfaceHolder.Callback, Choreographer.FrameCallback {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayAdapter<CharSequence> adapter =
        ArrayAdapter.createFromResource(this, R.array.scheduledSwapUpdateNames,
    ...
    adapter = ArrayAdapter.createFromResource(this, R.array.scheduledSwapAheadNames,
        android.R.layout.simple_spinner_item);
    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    spinner.setAdapter(adapter);
  ...
  @Override public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
    Log.d(TAG,
        "surfaceChanged fmt=" + format + " size=" + width + "x" + height + " holder=" + holder);
  ...
  private static class RenderThread extends Thread {
    ...
    private boolean advance(long frameTimeNs) {
      ...
      if (mPreviousRefreshNs != 0
        ...
        mChoreographerSkips++;
        complain = true;
        Log.d(TAG, frameTimeNs + ": Choreographer skip: " + ((frameTimeNs - mPreviousRefreshNs)
            / 1000000.0) + " ms");
      }
  ...
  private static class RenderHandler extends Handler {
    ...
    public void sendDoFrame(long frameTimeNanos) {
      sendMessage(obtainMessage(RenderHandler.MSG_DO_FRAME, (int) (frameTimeNanos >> 32),
          (int) frameTimeNanos));
    }
    ...
    public void sendSetParameters(int updatePatternIndex, int framesAheadIndex) {
      sendMessage(
          obtainMessage(RenderHandler.MSG_SET_PARAMETERS, updatePatternIndex, framesAheadIndex));
    }
